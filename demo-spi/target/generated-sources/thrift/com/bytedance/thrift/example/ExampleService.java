...
public class ExampleService {
  ...
  public interface Iface {
    ...
    public ExampleResponse Visit(ExampleRequest req) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void Visit(ExampleRequest req, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_Visit(ExampleRequest req) throws org.apache.thrift.TException
    {
    ...
    public ExampleResponse recv_Visit() throws org.apache.thrift.TException
    {
      ...
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "Visit failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void Visit(ExampleRequest req, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      Visit_call method_call = new Visit_call(req, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class Visit_call extends org.apache.thrift.async.TAsyncMethodCall {
      private ExampleRequest req;
      public Visit_call(ExampleRequest req, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public ExampleResponse getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_Visit();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class Visit<I extends Iface> extends org.apache.thrift.ProcessFunction<I, Visit_args> {
      public Visit() {
        super("Visit");
      }
      ...
      public Visit_result getResult(I iface, Visit_args args) throws org.apache.thrift.TException {
        Visit_result result = new Visit_result();
        result.success = iface.Visit(args.req);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class Visit<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, Visit_args, ExampleResponse> {
      public Visit() {
        super("Visit");
      }
      ...
      public AsyncMethodCallback<ExampleResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<ExampleResponse>() { 
          public void onComplete(ExampleResponse o) {
            Visit_result result = new Visit_result();
            result.success = o;
            try {
      ...
      public void start(I iface, Visit_args args, org.apache.thrift.async.AsyncMethodCallback<ExampleResponse> resultHandler) throws TException {
        iface.Visit(args.req,resultHandler);
      }
    }

  }

  public static class Visit_args implements org.apache.thrift.TBase<Visit_args, Visit_args._Fields>, java.io.Serializable, Cloneable, Comparable<Visit_args>   {
    ...
    public ExampleRequest req; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.REQ, new org.apache.thrift.meta_data.FieldMetaData("req", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ExampleRequest.class)));
    ...
    public Visit_args(Visit_args other) {
      if (other.isSetReq()) {
        this.req = new ExampleRequest(other.req);
      }
    }
    ...
    public ExampleRequest getReq() {
      return this.req;
    }

    public Visit_args setReq(ExampleRequest req) {
      this.req = req;
      return this;
    }
  ...
  public static class Visit_result implements org.apache.thrift.TBase<Visit_result, Visit_result._Fields>, java.io.Serializable, Cloneable, Comparable<Visit_result>   {
    ...
    public ExampleResponse success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ExampleResponse.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public Visit_result(Visit_result other) {
      if (other.isSetSuccess()) {
        this.success = new ExampleResponse(other.success);
      }
    }
    ...
    public ExampleResponse getSuccess() {
      return this.success;
    }

    public Visit_result setSuccess(ExampleResponse success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((ExampleResponse)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, Visit_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new ExampleResponse();
